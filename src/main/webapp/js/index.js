...
if (userId != "") {
	...
	if (userAuthority == "SUTDENT") {
		...
		callToActionMsg.innerHTML = "欢迎您的登陆";
		var callToActionBtn = document.getElementById("call-to-action-btn-1");
		callToActionBtn.innerHTML = "点击进入教师面板";
		callToActionBtn.href = "goToTeacherPanelAction.do";
		...
		callToActionMsg.innerHTML = "欢迎您的登陆";
		var callToActionBtn = document.getElementById("call-to-action-btn-1");
		callToActionBtn.innerHTML = "点击进入管理员面板";
		callToActionBtn.href = "goToAdminPanelAction.do";
	}
}
